...
(function (global, factory) {
  ...
  var Collapse = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto.show = function show() {
      ...
      var container-fluid = SelectorEngine.findOne(this._selector);

      if (actives) {
        var tempActiveData = actives.find(function (elem) {
          return container-fluid !== elem;
        });
  ...
  */
  ...
  } // A "clipping parent" is an overflowable container-fluid with the characteristic of
  ...
  var DefaultType$4 = {
    ...
    offset: '(array|string|function)',
    container-fluid: '(string|element|boolean)',
  ...
  var Tooltip = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto.show = function show() {
      ...
      var container-fluid = this._getcontainer-fluid();

      Data.setData(tip, this.constructor.DATA_KEY, this);

      if (!this._element.ownerDocument.documentElement.contains(this.tip)) {
        container-fluid.appendChild(tip);
      }
    ...
    _proto._getcontainer-fluid = function _getcontainer-fluid() {
      if (this.config.container-fluid === false) {
        return document.body;
      }

      if (isElement(this.config.container-fluid)) {
        return this.config.container-fluid;
      }

      return SelectorEngine.findOne(this.config.container-fluid);
    };
    ...
    _proto._getConfig = function _getConfig(config) {
      ...
      if (config && typeof config.container-fluid === 'object' && config.container-fluid.jquery) {
        config.container-fluid = config.container-fluid[0];
      }
  ...
  var Tab = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto._activate = function _activate(element, container-fluid, callback) {
      var _this2 = this;

      var activeElements = container-fluid && (container-fluid.nodeName === 'UL' || container-fluid.nodeName === 'OL') ? SelectorEngine.find(SELECTOR_ACTIVE_UL, container-fluid) : SelectorEngine.children(container-fluid, SELECTOR_ACTIVE$1);
